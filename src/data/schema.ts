...
export const granbyLocationSchema = {
  ...
  email: 'chaos.chemistry.massage@gmail.com',
  image: [
    `${SITE}/photos/granby/exterior.jpg`,
    `${SITE}/photos/granby/reception.jpg`,
    `${SITE}/photos/granby/treatment-room.jpg`,
    `${SITE}/sarah.jpg`,
  ],
  primaryImageOfPage: `${SITE}/photos/granby/treatment-room.jpg`,
  priceRange: '$$',
  description:
...
export const winterParkLocationSchema = {
  ...
  email: 'chaos.chemistry.massage@gmail.com',
  image: [
    `${SITE}/photos/winter-park/reception.jpg`,
    `${SITE}/photos/winter-park/treatment-room.jpg`,
    `${SITE}/photos/winter-park/couples-room.jpg`,
    `${SITE}/sarah.jpg`,
  ],
  primaryImageOfPage: `${SITE}/photos/winter-park/treatment-room.jpg`,
  priceRange: '$$',
  description:
